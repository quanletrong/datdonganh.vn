                                ...
                                <tbody>
                                    <?php foreach ($list as $id_articles => $articles) { ?>
                                        <tr>
                                            ...
                                            <td class="align-middle"><a href="document/edit/<?= $id_articles ?>"><?= $articles['title'] ?></a></td>
                                            ...
                                            <td class="align-middle text-center">
                                                <a href="document/edit/<?= $id_articles ?>" class="btn btn-sm btn-primary mb-1">
                                                    Sửa
                                                </a>
...
<script>
    $(function() {
        ...
        $('#modal-delete').on('show.bs.modal', function(event) {
            ...
            $('#btn_xoa').attr('href', `<?= site_url('document/delete') ?>/${id_article}`);
