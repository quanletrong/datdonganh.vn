    ...
    <div class="row" style="background-color: #dee2e6; padding-top: 1rem; margin-bottom: 1rem;">
        ...
        <div class="col-md-6 mb-3">
            <div class="input-group">
                ...
                <input type="number" min=1 step="0.01" class="form-control " name="f_price" value="<?= @$_GET['f_price'] ?>">
                ...
                <input type="number" min=1 step="0.01" class="form-control" name="t_price" value="<?= @$_GET['t_price'] ?>">
        ...
        <div class="col-md-3 mb-3">
            <div class="input-group">
                <div class="input-group-append">
                    <div class="input-group-text p-0">Đơn vị giá</div>
                </div>
        ...
        <div class="col-md-3 mb-3">
            <div class="input-group">
                ...
                <input type="number" min=30 class="form-control " name="f_acreage" value="<?= @$_GET['f_acreage'] ?>">
                <div class="input-group-append">
                    <div class="input-group-text p-0">đến</div>
                </div>
                <input type="number" min=30 class="form-control" name="t_acreage" value="<?= @$_GET['t_acreage'] ?>">
            </div>
        </div>
