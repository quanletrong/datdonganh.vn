                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows=6 name=maps><?= html_entity_decode(htmlspecialchars_decode($info['maps'])) ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label>Hiển thị vị trí</label>
                                <?= html_entity_decode(htmlspecialchars_decode($info['maps'])) ?>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Giá</label>
                                    <input class="form-control" type="text" name="price" value="<?= $info['price'] ?>" style="font-size: 2rem;">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2" style="width: 100%;" name="toilet">
                                        ...
                                        <?php foreach ($cf_bds['toilet'] as $id => $name) { ?>
                                            <option value="<?= $id ?>" <?= $info['toilet'] == $id ? 'selected' : '' ?>><?= $name ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2" style="width: 100%;" name="floor">
                                        ...
                                        <?php foreach ($cf_bds['floor'] as $id => $name) { ?>
                                            <option value="<?= $id ?>" <?= $info['floor'] == $id ? 'selected' : '' ?>><?= $name ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2" style="width: 100%;" name="bedroom">
                                        ...
                                        <?php foreach ($cf_bds['bedroom'] as $id => $name) { ?>
                                            <option value="<?= $id ?>" <?= $info['bedroom'] == $id ? 'selected' : '' ?>><?= $name ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group d-flex">
                                    ...
                                    <div class="d-flex w-100">
                                        <?php foreach ($cf_bds['noithat'] as $id => $name) { ?>
                                            <div class="custom-control custom-radio" style="width: 30%;">
                                                <input class="custom-control-input" type="radio" id="noithat_<?= $id ?>" name="noithat" value="<?= $id ?>" <?= $id == $info['noithat'] ? 'checked' : '' ?>>
        ...
        $('#frm_bds').validate({
            ...
            messages: {
                ...
                price: {
                    ...
                    valid_price: 'Giá nhỏ nhất là 100 triệu hoặc không nhập'
                },
                acreage: {
                ...
                road_surface: {
                    ...
                    min: 'Đường vào tối thiểu 1m hoặc không nhập'
                },
                expired: {
