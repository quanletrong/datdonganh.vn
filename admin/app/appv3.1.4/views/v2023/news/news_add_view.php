...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Đăng bài tin tức</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= site_url('home') ?>">Home</a></li>
                        <li class="breadcrumb-item"><a href="<?= site_url('news') ?>">Quản lý tin tức</a></li>
                        <li class="breadcrumb-item active">Đăng bài tin tức</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid pb-5">
            <form id="frm_news" action="<?= site_url('news/add_submit') ?>" method="post">
...
<script>
    ...
    function remove_image(image_id) {
        ...
        let count_total_image = $('#frm_news').find('.image_input').filter(function() {
