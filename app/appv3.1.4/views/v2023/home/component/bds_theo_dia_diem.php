                ...
                <?php if ($index%2) {?>
                    <div class="col-12">
                        <div class="position-relative">
                            ...
                            <img class="img-alive" src="<?php echo $chunk[0]['image_path'] ?>"
                                class=" w-100" alt="">
                    ...
                    <div class="col-6">
                        <div class="position-relative">
                            <div style="background: linear-gradient(180deg, rgba(0,0,0,0) 0%, rgba(0,0,0,0.7) 100%);
                            transform: rotate(-180deg); position: absolute; top: 0; left: 0; width: 100%; height: 50%;"></div>
                            <img class="img-alive" src="<?php echo $chunk[1]['image_path'] ?>"
                                class=" w-100" alt="">
                            <div class="position-absolute" style="top:10px; left: 10px;">
                    ...
                    <div class="col-6">
                        <div class="position-relative">
                            <div style="background: linear-gradient(180deg, rgba(0,0,0,0) 0%, rgba(0,0,0,0.7) 100%);
                            transform: rotate(-180deg); position: absolute; top: 0; left: 0; width: 100%; height: 50%;"></div>
                            <img class="img-alive" src="<?php echo $chunk[2]['image_path'] ?>"
                                class=" w-100" alt="">
                            <div class="position-absolute" style="top:10px; left: 10px;">
