...
<div class="container mt-3">
    <div class="row">
        <div class="col-12 col-lg-8">
            <div class="position-relative" id="preview-header">
                <img id="img-preview" src=""
                    class="w-100 img-fluid img-alive" alt="" style="aspect-ratio: 16/9; object-fit: cover;">

                <div class="position-absolute"
                    style="background: linear-gradient(180deg, rgba(0,0,0,0) 0%, rgba(0,0,0,0.7) 100%); border-radius: 4px; transform: rotate(0); position: absolute; bottom: 0; width: 100%; height: 50%;">
                </div>
                <div class="position-absolute" style="bottom: 2rem; left: 2rem;">
                    <div class="text-light" id="date-preview">28/04/2023 11:10 • Tin tức</div>
        ...
        <div class="col-12 col-lg-4" id="list-news-header">
            <?php foreach($news_new as $news){ ?>
            <div class="py-3 mb-2 news-header" data-id="<?php echo $news['id_articles']; ?>">
                <div class="text-muted" style="font-size: 0.875rem;"><?php echo  $news['update_time'] == "" ? date('d/m/Y h:i', strtotime($news['create_time'])) : date('d/m/Y h:i', strtotime($news['update_time'])) ?> • tin tức</div>
                <a href="">
...
<input type="hidden" id="data-news-header" value="<?php echo htmlspecialchars(json_encode($news_new)); ?>" />
<script>
    $(function(){
       preview_article();
