...
<div class="container">
    ...
    <div class="mt-5 d-flex justify-content-center align-items-center flex-column">
        ...
        <p class="my-2 w-50 fw-semibold d-none d-lg-block" style="font-size: 16px;">
            ...
            dịch, nguồn cung - cầu và khảo sát thực tế của đội ngũ phóng viên, biên tập của <span
                class="text-danger">datdonganh.vn</sâpn>
        </p>
    </div>
</div>
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-4">
            <div class="border rounded p-3">
                <p class="fw-semibold" style="font-size: 1.125rem;">Tin tức được xem nhiều nhất</p>

                <?php $i= 1; foreach($news_view_top as $news){ ?>
                <hr class="text-muted">
            ...
            <div class="sticky-lg-top border rounded p-3 mt-5 d-none" style="top:100px; z-index:1019 !important">
                <p class="fw-semibold" style="font-size: 1.125rem;">Tin tức theo khu vực</p>

                <hr class="text-muted">
                <div class="d-flex align-items-center" style="gap:10px">
                    <img src="https://img.iproperty.com.my/angel/520x300-crop/wp-content/uploads/sites/7/2023/04/bds-1-2.jpg" style="width: 50px; aspect-ratio: 16/9; object-fit: cover;" class="rounded" alt="">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-4">
                                <div class="position-relative">
                                    ...
                                    <div class="position-absolute bg-secondary text-light px-2 rounded-end fw-semibold"
                                        style="top:10px; font-size: 0.625rem;">tin tức</div>
                                </div>

                            </div>
                            <div class="col-12 col-lg-8">
                                <div class="text-muted" style="font-size: 0.875rem;">${formattedDate} • tin tức</div>
