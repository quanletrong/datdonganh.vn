...
class Login extends MY_Controller{
    ...
    function ggcallback() {
        ...
        if (!empty($uinfo)) {
            ...
            $this->session->set_userdata('phone', $uinfo['phonenumber']);
            ...
            $user_id = $this->Account_model->add($userData['id'], $password_hash, $userData['name'], $userData['email'], "", $avatar, USER, 1, 0);
