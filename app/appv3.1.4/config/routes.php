...
$route['bds/ajax-tang-luot-xem-bds/(:num)'] = 'bds/bds/ajax_tang_luot_xem_bds/$1';

$route[LINK_TIN_TUC]                        = 'news/news/index/';                    // danh sach tin tuc
$route[LINK_TIN_TUC.'/ajx']                 = 'news/news/ajx_more_data';             // ajx danh sach tin tuc
$route[LINK_TIN_TUC.'/(:any)-p(:num)']      = 'news/news/detail/$1/$2';              // chi tiet tin tức

$route[LINK_DAU_GIA]                        = 'auction/auction/index/';              // danh sach lich dau gia dat
$route[LINK_DAU_GIA.'/ajx']                 = 'auction/auction/ajx_more_data';       // ajx danh sachlich dau gia dat
$route[LINK_DAU_GIA.'/(:any)-p(:num)']      = 'auction/auction/detail/$1/$2';        // chi tiet lich dau gia dat

$route[LINK_TAI_LIEU]                       = 'document/document/index/';            // danh sach tai lieu
$route[LINK_TAI_LIEU.'/ajx']                = 'document/document/ajx_more_data';     // ajx danh sach tài liệu
