...
$config['bds']['price_list'][] = ['link' => LINK_NHA_DAT_BAN .'?f_price=1&t_price=1.5', 'name' => '1 → 1.5 tỷ', 'from' => 1, 'to'=> 1.5];
$config['bds']['price_list'][] = ['link' => LINK_NHA_DAT_BAN .'?f_price=1.5&t_price=2', 'name' => '1.5 → 2 tỷ', 'from' => 1.5, 'to'=> 2];
$config['bds']['price_list'][] = ['link' => LINK_NHA_DAT_BAN .'?f_price=2&t_price=2.5', 'name' => '2 → 2.5 tỷ','from' => 2, 'to'=> 2.5];
$config['bds']['price_list'][] = ['link' => LINK_NHA_DAT_BAN .'?f_price=2.5&t_price=3', 'name' => '2.5 → 3 tỷ','from' => 2.5, 'to'=> 3];
$config['bds']['price_list'][] = ['link' => LINK_NHA_DAT_BAN .'?f_price=3&t_price=4', 'name' => '3 → 4 tỷ', 'from' => 3, 'to'=> 4];
$config['bds']['price_list'][] = ['link' => LINK_NHA_DAT_BAN .'?f_price=4&t_price=5', 'name' => '4 → 5 tỷ', 'from' => 4, 'to'=> 5];
$config['bds']['price_list'][] = ['link' => LINK_NHA_DAT_BAN .'?f_price=5&t_price=6', 'name' => '5 → 6 tỷ', 'from' => 5, 'to'=> 6];
$config['bds']['price_list'][] = ['link' => LINK_NHA_DAT_BAN .'?f_price=6&t_price=8', 'name' => '6 → 8 tỷ', 'from' => 6, 'to'=> 8];
$config['bds']['price_list'][] = ['link' => LINK_NHA_DAT_BAN .'?f_price=8&t_price=10', 'name' => '8 → 10 tỷ', 'from' => 8, 'to'=> 10];
$config['bds']['price_list'][] = ['link' => LINK_NHA_DAT_BAN .'?f_price=10', 'name' => 'Trên 10 tỷ', 'from' => 10, 'to'=> ''];

$config['bds']['acreage_list'][] = ['link' => LINK_NHA_DAT_BAN .'?f_acreage=30&t_acreage=50', 'name' => '30 → 50 m²', 'from' => 30, 'to'=> 50];
$config['bds']['acreage_list'][] = ['link' => LINK_NHA_DAT_BAN .'?f_acreage=50&t_acreage=80', 'name' => '50 → 80 m²', 'from' => 50, 'to'=> 80];
$config['bds']['acreage_list'][] = ['link' => LINK_NHA_DAT_BAN .'?f_acreage=80&t_acreage=100', 'name' => '80 → 100 m²', 'from' => 80, 'to'=> 100];
$config['bds']['acreage_list'][] = ['link' => LINK_NHA_DAT_BAN .'?f_acreage=100&t_acreage=150', 'name' => '100 → 150 m²', 'from' => 100, 'to'=> 150];
$config['bds']['acreage_list'][] = ['link' => LINK_NHA_DAT_BAN .'?f_acreage=150&t_acreage=200', 'name' => '150 → 200 m²', 'from' => 150, 'to'=> 200];
$config['bds']['acreage_list'][] = ['link' => LINK_NHA_DAT_BAN .'?f_acreage=200&t_acreage=200', 'name' => '200 → 300 m²', 'from' => 200, 'to'=> 300];
$config['bds']['acreage_list'][] = ['link' => LINK_NHA_DAT_BAN .'?f_acreage=300&t_acreage=500', 'name' => '300 → 500 m²', 'from' => 300, 'to'=> 500];
$config['bds']['acreage_list'][] = ['link' => LINK_NHA_DAT_BAN .'?f_acreage=500', 'name' => 'Trên 500 m²', 'from' => 500, 'to'=> ''];
